(function (global, factory) {
  ...
  */
   ...
   */
  function forward$r(ll, accuracy) {
  ...
  Point.prototype.toMGRS = function (accuracy) {
    return forward$r([this.x, this.y], accuracy);
  };
  ...
  var names$r = ["Transverse_Mercator", "Transverse Mercator", "tmerc"];
  var tmerc = {
    init: init$r,
    forward: forward$q,
    inverse: inverse$q,
  ...
  var names$q = ["Extended_Transverse_Mercator", "Extended Transverse Mercator", "etmerc"];
  var etmerc = {
    init: init$q,
    forward: forward$p,
    inverse: inverse$p,
  ...
  var names$p = ["Universal Transverse Mercator System", "utm"];
  var utm = {
    init: init$p,
    names: names$p,
    dependsOn: dependsOn
  ...
  var names$n = ["Stereographic_North_Pole", "Oblique_Stereographic", "Polar_Stereographic", "sterea", "Oblique Stereographic Alternative", "Double_Stereographic"];
  var sterea = {
    init: init$n,
    forward: forward$n,
    inverse: inverse$n,
  ...
  var names$m = ["stere", "Stereographic_South_Pole", "Polar Stereographic (variant B)"];
  var stere = {
    init: init$m,
    forward: forward$m,
    inverse: inverse$m,
  ...
  var names$k = ["Hotine_Oblique_Mercator", "Hotine Oblique Mercator", "Hotine_Oblique_Mercator_Azimuth_Natural_Origin", "Hotine_Oblique_Mercator_Azimuth_Center", "omerc"];
  var omerc = {
    init: init$k,
    forward: forward$k,
    inverse: inverse$k,
  ...
  var names$j = ["Lambert Tangential Conformal Conic Projection", "Lambert_Conformal_Conic", "Lambert_Conformal_Conic_2SP", "lcc"];
  var lcc = {
    init: init$j,
    forward: forward$j,
    inverse: inverse$j,
  ...
  var names$g = ["Lambert Azimuthal Equal Area", "Lambert_Azimuthal_Equal_Area", "laea"];
  var laea = {
    init: init$g,
    forward: forward$g,
    inverse: inverse$g,
  ...
  */
  ...
  var names$c = ["Equirectangular", "Equidistant_Cylindrical", "eqc"];
  var eqc = {
    init: init$c,
    forward: forward$c,
    inverse: inverse$c,
  ...
  var names$a = ["New_Zealand_Map_Grid", "nzmg"];
  var nzmg = {
    init: init$a,
    forward: forward$a,
    inverse: inverse$a,
  ...
  var names$9 = ["Miller_Cylindrical", "mill"];
  var mill = {
    init: init$9,
    forward: forward$9,
    inverse: inverse$9,
  ...
  var names$6 = ["Equidistant_Conic", "eqdc"];
  var eqdc = {
    init: init$6,
    forward: forward$6,
    inverse: inverse$6,
  ...
  var names$5 = ["Van_der_Grinten_I", "VanDerGrinten", "vandg"];
  var vandg = {
    init: init$5,
    forward: forward$5,
    inverse: inverse$5,
  ...
  var names$4 = ["Azimuthal_Equidistant", "aeqd"];
  var aeqd = {
    init: init$4,
    forward: forward$4,
    inverse: inverse$4,
  ...
  var names$2 = ["Quadrilateralized Spherical Cube", "Quadrilateralized_Spherical_Cube", "qsc"];
  var qsc = {
    init: init$2,
    forward: forward$2,
    inverse: inverse$2,
  ...
  */
  ...
  exports.checkGr = checkGr;
  exports.getCentroid = getCentroid;
  exports.getGjson = getGjson;
  exports.getGrFromCoords = getGrFromCoords;
  exports.getLowerResGrs = getLowerResGrs;
  exports.pntToArea = pntToArea;
