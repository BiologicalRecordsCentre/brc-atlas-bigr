(function (global, factory) {
  ...
  (global = global || self, factory(global.bigr = {}));
  ...
  function getGrFromCoords(x, y, fromProjection, toProjection, precisions) {
    ...
    if (!toProjection) {
      if (fromProjection === 'wg') {
        ...
        var lonlat = proj4(projections$1[fromProjection].proj4, projections$1['wg'].proj4, [x, y]);
    ...
    if (fromProjection !== toProjection) {
      var outCoords = proj4(projections$1[fromProjection].proj4, projections$1[toProjection].proj4, [x, y]);
      x = outCoords[0];
      y = outCoords[1];
    }
